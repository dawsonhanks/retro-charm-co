/** @typedef {'starter' | 'charms' | 'dangles'} CharmCategory */
...
export const charms = [
  ...
  { id: 'g-fish-dangle-green-white', name: 'Fish Dangle - Green/White', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/animals-characters/fish-dangle-green-white-gold.webp' },
  ...
  { id: 'g-dangle-blue-teal', name: 'Dangle - Blue/Teal', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/birthstone-dangles/dangle-blue-teal-gold.webp' },
  { id: 'g-dangle-clear', name: 'Dangle - Clear', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/birthstone-dangles/dangle-clear-gold.webp' },
  { id: 'g-dangle-garnet', name: 'Dangle - Garnet', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/birthstone-dangles/dangle-garnet-gold.webp' },
  { id: 'g-dangle-green', name: 'Dangle - Green', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/birthstone-dangles/dangle-green-gold.webp' },
  { id: 'g-dangle-pink-magenta', name: 'Dangle - Pink/Magenta', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/birthstone-dangles/dangle-pink-magenta-gold.webp' },
  { id: 's-dangle-red-ruby', name: 'Dangle - Red/Ruby', category: 'dangles', price: 3.95, metal: 'silver', iconType: 'image', image: '/images/charms/birthstone-dangles/dangle-red-ruby-silver.webp' },
  ...
  { id: 'g-cherries-dangle', name: 'Cherries Dangle', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/cherries-dangle-gold.webp' },
  { id: 'g-fish-dangle-teal-white-2', name: 'Fish Dangle - Teal/White (2)', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/fish-dangle-teal-white-2-gold.webp' },
  { id: 's-heart-coin-dangle-antique-bronze', name: 'Heart Coin Dangle - Antique Bronze', category: 'dangles', price: 3.95, metal: 'silver', iconType: 'image', image: '/images/charms/dangle-charms/heart-coin-dangle-antique-bronze-silver.webp' },
  { id: 'g-heart-coin-dangle-silver-sunburst', name: 'Heart Coin Dangle - Silver Sunburst', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/heart-coin-dangle-silver-sunburst-gold.webp' },
  { id: 'g-heart-dangle-gold', name: 'Heart Dangle - Gold', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/heart-dangle-gold-gold.webp' },
  { id: 'g-heart-dangle-silver', name: 'Heart Dangle - Silver', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/heart-dangle-silver-gold.webp' },
  { id: 's-heart-dangle-silver-2', name: 'Heart Dangle - Silver (2)', category: 'dangles', price: 3.95, metal: 'silver', iconType: 'image', image: '/images/charms/dangle-charms/heart-dangle-silver-2-silver.webp' },
  { id: 's-pearl-dangle', name: 'Pearl Dangle', category: 'dangles', price: 3.95, metal: 'silver', iconType: 'image', image: '/images/charms/dangle-charms/pearl-dangle-silver.webp' },
  { id: 'g-star-dangle-gold', name: 'Star Dangle - Gold', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/star-dangle-gold-gold.webp' },
  { id: 's-star-dangle-silver', name: 'Star Dangle - Silver', category: 'dangles', price: 3.95, metal: 'silver', iconType: 'image', image: '/images/charms/dangle-charms/star-dangle-silver-silver.webp' },
  { id: 'g-strawberry-dangle', name: 'Strawberry Dangle', category: 'dangles', price: 3.95, metal: 'gold', iconType: 'image', image: '/images/charms/dangle-charms/strawberry-dangle-gold.webp' },
  { id: 's-strawberry-dangle-2', name: 'Strawberry Dangle (2)', category: 'dangles', price: 3.95, metal: 'silver', iconType: 'image', image: '/images/charms/dangle-charms/strawberry-dangle-2-silver.webp' },
